...
public class SignUp extends AppCompatActivity {
    ...
    /***
     * this is signUp Listener method that handles  multiple event listeners in sigUp page
     * @param signUpView: this is a Event object that can handle multiple events.
     */
